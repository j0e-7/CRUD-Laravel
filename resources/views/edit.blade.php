...
<form action="{{url('/estudiantes/'.$estudiante['cedula'])}}" method="POST">
  ...
  <input type="text" name ="cedula" class="form-control" id="cedula" value="{{$estudiante['cedula']}}">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text"  name ="apellido" class="form-control" id="apeliido" value="{{$estudiante['apellido']}}">
  </div>
  <div class="mb-3">
